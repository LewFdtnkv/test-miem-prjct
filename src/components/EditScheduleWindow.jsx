...
export default function EditScheduleWindow({ setRest, setMode, selectedDates, setSelectedDates, time, setTime,format }) {
  ...
  return (
    <div className="modal-container">
      <div className="schedule-edit">
        <h2 className='h2_schedule'>Редактирование графика работы {<CloseOutlined onClick={handleClose}/>}</h2>
      
        <div className="commission-info">Комиссия №1<br />НИР</div>
        <Input
        ...
        <div className="buttons_edit">
          <button
            onClick={() => {setMode('default');setSelectedDates([dayjs()]);}}
